...
export default function VacationSheets() {
  ...
  const handleFormSubmit = (data: Omit<VacationSheet, 'id' | 'vacation_days_taken'>) => {
    ...
    if (selectedSheet) {
      const updateData: VacationSheet = {
        ...data,
        id: selectedSheet.id,
        vacation_days_taken: selectedSheet.vacation_days_taken, // Required only for display, not submission
      };
  ...
  return (
      <Container maxWidth={false} style={{ width: '100%', overflowX: 'auto' }}>
                ...
                <Table style={{ minWidth: 1800 }}>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>
                        <Typography>Vacation Days Taken</Typography>
                      </TableCell>
                      <TableCell>
                  ...
                  <TableBody>
                    {data.vacation_sheets.map(sheet => (
                        <TableRow key={sheet.id}>
                          ...
                          <TableCell>{sheet.employee_leader}</TableCell>
